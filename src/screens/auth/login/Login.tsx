  ...
  return (
    <div>
      <div className="bg-white relative">
        <div
          className="flex flex-col items-center justify-between pt-0 
        sm:pr-10 pb-0 sm:pl-10 mt-0 mr-auto mb-0 ml-auto sm:max-w-7xl xl:px-5 lg:flex-row"
        >
              ...
              >
                ...
                <div className="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                  ...
                  <div className="relative">
                    ...
                    >
                      <div
                        className="bg-blue-500 text-white rounded-xl h-12 w-1/4 flex items-center 
                      justify-center absolute left-1 top-[4px] group-hover:w-[98%] z-10 duration-500"
                      >
                        <IconLogin2 />
                      </div>
                      <p className="pt-2 text-lg translate-x-2">Log in</p>
                    </button>
                  </div>
